...
{
	using System;
	partial class BillExpense : QnSBillShare.Contracts.Business.App.IBillExpense
	{
		static BillExpense()
		{
			ClassConstructing();
		...
		{
			if (!(obj is QnSBillShare.Contracts.Business.App.IBillExpense instance))
			{
				return false;
			}
			return base.Equals(instance) && Equals(instance);
		}
		protected bool Equals(QnSBillShare.Contracts.Business.App.IBillExpense other)
		{
			if (other == null)
			{
				return false;
		...
		{
			return HashCode.Combine(Id, Timestamp, Bill, Expenses, Id, TotalExpense, HashCode.Combine(FriendPortion, NumberOfFriends, Friends, FriendAmounts, Balances));
		}
	}
}
namespace QnSBillShare.Logic.Entities.Business.App
{
	partial class BillExpense : IdentityObject
	{
	}
}
